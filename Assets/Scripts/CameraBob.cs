...
namespace UnityStandardAssets.Characters.FirstPerson
{
	public class CameraBob : MonoBehaviour
	{
		...
		{
			//housePosition = new Vector3 (Random.Range(180,190), Random.Range(8,10), Random.Range(45,50));
			//GameObject clone = Instantiate (house, housePosition, house.transform.rotation) as GameObject;
		...
		protected void OnGUI()
		{
			if (!debug)
				return;
			GUILayout.Label("house position: " + housePosition);
